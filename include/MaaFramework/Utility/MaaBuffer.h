...
MAA_FRAMEWORK_API MaaStringBufferHandle MaaGetStringListAt(MaaStringListBufferHandle handle, MaaSize index);
// append a deep copy of value, you still need to destory it.
MAA_FRAMEWORK_API MaaBool MaaStringListAppend(MaaStringListBufferHandle handle, MaaStringBufferHandle value);
...
MAA_FRAMEWORK_API MaaImageBufferHandle MaaGetImageListAt(MaaImageListBufferHandle handle, MaaSize index);
// append a deep copy of value, you still need to destory it.
MAA_FRAMEWORK_API MaaBool MaaImageListAppend(MaaImageListBufferHandle handle, MaaImageBufferHandle value);
