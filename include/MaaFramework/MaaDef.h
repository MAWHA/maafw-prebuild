...
enum MaaAdbControllerTypeEnum {
    ...
    MaaAdbControllerType_Input_Preset_Maatouch   = MaaAdbControllerType_Touch_MaaTouch | MaaAdbControllerType_Key_MaaTouch,
    MaaAdbControllerType_Input_Preset_AutoDetect = MaaAdbControllerType_Touch_AutoDetect | MaaAdbControllerType_Key_AutoDetect,
