...
MAA_FRAMEWORK_API MaaBool MaaSyncContextClick(MaaSyncContextHandle sync_context, int32_t x, int32_t y);
MAA_FRAMEWORK_API MaaBool
    MaaSyncContextSwipe(MaaSyncContextHandle sync_context, int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t duration);
MAA_FRAMEWORK_API MaaBool MaaSyncContextPressKey(MaaSyncContextHandle sync_context, int32_t keycode);
MAA_FRAMEWORK_API MaaBool MaaSyncContextInputText(MaaSyncContextHandle sync_context, MaaStringView text);
...
MAA_FRAMEWORK_API MaaBool MaaSyncContextTouchUp(MaaSyncContextHandle sync_context, int32_t contact);

MAA_FRAMEWORK_API MaaBool MaaSyncContextScreencap(MaaSyncContextHandle sync_context, MaaImageBufferHandle out_image /* out */);

MAA_FRAMEWORK_API MaaBool
    MaaSyncContextCachedImage(MaaSyncContextHandle sync_context, MaaImageBufferHandle out_image /* out */);
