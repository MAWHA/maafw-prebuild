 ...
 */
MAA_FRAMEWORK_API MaaResourceHandle MaaResourceCreate(MaaResourceCallback callback, MaaCallbackTransparentArg callback_arg);
...
MAA_FRAMEWORK_API MaaBool MaaResourceSetOption(
    MaaResourceHandle res, MaaResOption key, MaaOptionValue value /**< Maybe a byte array */, MaaOptionValueSize val_size);
 ...
 * @return MaaBool
 */
MAA_FRAMEWORK_API MaaBool MaaResourceGetHash(MaaResourceHandle res, /* out */ MaaStringBufferHandle buffer);
 ...
 * @return MaaBool
 */
MAA_FRAMEWORK_API MaaBool MaaResourceGetTaskList(MaaResourceHandle res, /* out */ MaaStringBufferHandle buffer);
