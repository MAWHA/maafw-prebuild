...
MAA_FRAMEWORK_API MaaBool MaaSetOption(
    MaaInstanceHandle inst, MaaInstOption key, MaaOptionValue value /**< Maybe a byte array */, MaaOptionValueSize val_size);
 ...
 */
MAA_FRAMEWORK_API MaaTaskId MaaPostRecognition(MaaInstanceHandle inst, MaaStringView entry, MaaStringView param);
 ...
 */
MAA_FRAMEWORK_API MaaTaskId MaaPostAction(MaaInstanceHandle inst, MaaStringView entry, MaaStringView param);
